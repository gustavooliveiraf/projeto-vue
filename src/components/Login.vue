<template>
  <div class="form-signin">
    <form>
      ...
      <router-link :to="{ name: 'Album'}"><button class="btn btn-lg btn-primary btn-block" type="submit">Entrar</button></router-link>
      <button class="btn btn-lg red-btn-primary btn-block" type="submit">Cadastre-se</button>
